...
## Project Structure
    ...
    ├── test_app_for_cat_41948  # Django project configurations
...
1. Clone this repo and `cd test_app_for_cat_41948`
...
2. Clone this repo and `cd test_app_for_cat_41948`
