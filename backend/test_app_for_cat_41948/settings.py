"""
Django settings for test_app_for_cat_41948 project.
...
ROOT_URLCONF = 'test_app_for_cat_41948.urls'
...
WSGI_APPLICATION = 'test_app_for_cat_41948.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_app_for_cat_41948 API",
    "DESCRIPTION": "API documentation for test_app_for_cat_41948 App",
    "VERSION": "v1",
}
